...
namespace Itenium.SkillForge.Data.Migrations
{
    ...
    [Migration("20260313141845_UserProfileAssignment")]
    partial class UserProfileAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.SkillDependencyEntity", b =>
                {
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.SkillEntity", b =>
                {
                    ...
                    b.ToTable("Skills", t =>
                        {
                            t.HasCheckConstraint("CK_Skills_LevelCount", "\"LevelCount\" BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.SkillDependencyEntity", b =>
                {
                    b.HasOne("Itenium.SkillForge.Entities.SkillEntity", "Prerequisite")
                        .WithMany()
            ...
            modelBuilder.Entity("Itenium.SkillForge.Entities.SkillEntity", b =>
                {
                    b.HasOne("Itenium.SkillForge.Entities.SkillProfileEntity", "Profile")
                        .WithMany("Skills")
